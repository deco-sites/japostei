    ...
    <div class="bg-[#1d2f06]">
      <div class="lg:container mx-auto md:max-w-6xl px-4 pt-16 text-sm">
        <div class="flex flex-col gap-20">
          ...
          <div class="border-primary border-t flex flex-col gap-4 lg:justify-between p-16">
            <div class="flex flex-col gap-4 items-center lg:flex-row justify-between lg:gap-6">
